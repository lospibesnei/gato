...
class EntrevistaControllerTest < ActionController::TestCase
  ...
  test "should create entrevistum" do
    assert_difference('Entrevistum.count') do
      post :create, entrevistum: { asistencia: @entrevistum.asistencia, observacion: @entrevistum.observacion, tipoentrevista: @entrevistum.tipoentrevista }
    end
  ...
  test "should update entrevistum" do
    patch :update, id: @entrevistum, entrevistum: { asistencia: @entrevistum.asistencia, observacion: @entrevistum.observacion, tipoentrevista: @entrevistum.tipoentrevista }
    assert_redirected_to entrevistum_path(assigns(:entrevistum))
  end
